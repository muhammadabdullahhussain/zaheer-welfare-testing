        ...
        <div className="flex items-center">
          ...
          >
            <li className="relative group">
              <Link href="/" onClick={handleLinkClick} className={` ${pathname !== '/' ? 'text-black' : ' '}  px-3 ${pathname === '/' ? 'text-blue' : ''} underline-offset-8 decoration-4 decoration-rose-500 hover:decoration-gap-2 transition-all duration-300 ease-in-out hover:text-[#EF1E60] `} >Home</Link>
              <div className="absolute left-0 w-0 h-[3px] bg-[#EF1E60] transition-all duration-300 ease-in-out group-hover:w-full"></div>
            </li>
            <li className="relative group">
              <Link href="/about" onClick={handleLinkClick} className={` ${pathname !== '/' ? 'text-black' : ' '}  px-3 ${pathname === '/about' ? 'text-blue' : ''} underline-offset-8 decoration-4 decoration-rose-500 hover:decoration-gap-2 transition-all duration-300 ease-in-out hover:text-[#EF1E60] `} >About</Link>
              <div className="absolute left-0 w-0 h-[3px] bg-[#EF1E60] transition-all duration-300 ease-in-out group-hover:w-full"></div>
            </li>
            <li className="relative group">
              <Link href="/contact" onClick={handleLinkClick} className={` ${pathname !== '/' ? 'text-black' : ' '}  px-3 ${pathname === '/contact' ? 'text-blue' : ''} underline-offset-8 decoration-4 decoration-rose-500 hover:decoration-gap-2 transition-all duration-300 ease-in-out hover:text-[#EF1E60] `} >Contact</Link>
              <div className="absolute left-0 w-0 h-[3px] bg-[#EF1E60] transition-all duration-300 ease-in-out group-hover:w-full"></div>
            </li>
            <li className="relative group">
              <Link href="/gallery" onClick={handleLinkClick} className={` ${pathname !== '/' ? 'text-black' : ' '}  px-3 ${pathname === '/gallery' ? 'text-blue' : ''} underline-offset-8 decoration-4 decoration-rose-500 hover:decoration-gap-2 transition-all duration-300 ease-in-out hover:text-[#EF1E60] `} >Gallery</Link>
              <div className="absolute left-0 w-0 h-[3px] bg-[#EF1E60] transition-all duration-300 ease-in-out group-hover:w-full"></div>
            </li>
            <li>
